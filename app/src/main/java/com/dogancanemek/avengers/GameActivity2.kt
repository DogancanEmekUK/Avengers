...
class GameActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fightText.text = "$name, we'll do this together too!"
        ...
        object : CountDownTimer(20000, 1000) {
            ...
            override fun onFinish() {
                ...
                //Alert
                val alert = AlertDialog.Builder(this@GameActivity2)
                alert.setTitle("Game Over")
                alert.setMessage("Would you like to go to the next level? You have to get 10 points to finish the game.")
